    ...
    public void initRecipes() {
        if (ConfigHandler.electricFloodlight || ConfigHandler.smallElectricFloodlight || ConfigHandler.uvFloodlight) {
            GameRegistry.addRecipe(
                    ...
                    " L ",
                    'R',
                    new ItemStack(getMinecraftItem("redstone"), 1),
                    'G',
            ...
            GameRegistry.addRecipe(
                    ...
                    " I ",
                    'G',
                    new ItemStack(getMinecraftItem("glass_pane"), 1),
                    'F',
        ...
        if (ConfigHandler.carbonFloodlight) {
            GameRegistry.addRecipe(
                    ...
                    new ItemStack(getMinecraftItem("iron_ingot"), 1));
            GameRegistry.addRecipe(
                    new ItemStack(ModItems.mantle, 1),
                    "SSS",
                    "SRS",
                    "SSS",
                    'R',
                    new ItemStack(getMinecraftItem("redstone"), 1),
                    'S',
                    new ItemStack(getMinecraftItem("string"), 1));
            GameRegistry.addRecipe(
