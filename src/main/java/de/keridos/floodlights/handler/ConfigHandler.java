...
public class ConfigHandler {
    ...
    public void initConfig(Configuration config) {
        ...
        chanceGrowLight = config.getFloat(
                ...
                0F,
                1F,
                "How big should the chance for the growlight for a growtick per second be?");
        timeoutFloodlights = config.getInt(
                "timeoutFloodlights",
                "general",
                40,
                1,
                240,
                "How long should the timeout for turning on floodlights again be in ticks?");
        damageUVFloodlight = config.getFloat(
                "damageUVFloodlight",
                "general",
                4.0F,
                1.0F,
